...
const DropDownToolbar: FC<Props> = ({ label, selects, styleAddition, width = "180px" }: Props) => {
    ...
    return (
        <div className={style.dropDown} ref={dropdownRef} style={styleAddition}>
            <label htmlFor={label}>{label}</label>
            <div className={style.dropDownMenu}>
                <button style={{ width: width }} id={label} onClick={handleClick}>
                    {mainSelect}
                </button>
